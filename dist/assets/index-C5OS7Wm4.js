...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ba,depthTest:!1,depthWrite:!1})}function i_(){return new Oi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:hu(),fragmentShader:`
		...
		`,blending:ba,depthTest:!1,depthWrite:!1})}function a_(){return new Oi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:hu(),fragmentShader:`
		...
		`,blending:ba,depthTest:!1,depthWrite:!1})}function hu(){return`
	...
	`}class _x extends qi{constructor(e=1,i={}){super(e,e,i),this.isWebGLCubeRenderTarget=!0;const s={width:e,height:e,depth:1},l=[s,s,s,s,s,s];this.texture=new fx(l),this._setTextureOptions(i),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,i){this.texture.type=i.type,this.texture.colorSpace=i.colorSpace,this.texture.generateMipmaps=i.generateMipmaps,this.texture.minFilter=i.minFilter,this.texture.magFilter=i.magFilter;const s={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},l=new fl(5,5,5),c=new Oi({name:"CubemapFromEquirect",uniforms:Xs(s.uniforms),vertexShader:s.vertexShader,fragmentShader:s.fragmentShader,side:Zn,blending:ba});c.uniforms.tEquirect.value=i;const f=new Ki(l,c),p=i.minFilter;return i.minFilter===Hr&&(i.minFilter=Bn),new PE(1,10,this).update(e,f),i.minFilter=p,f.geometry.dispose(),f.material.dispose(),this}clear(e,i=!0,s=!0,l=!0){const c=e.getRenderTarget();for(let f=0;f<6;f++)e.setRenderTarget(this,f),e.clear(i,s,l);e.setRenderTarget(c)}}function DA(r){let e=new WeakMap,i=new WeakMap,s=null;function l(v,b=!1){return v==null?null:b?f(v):c(v)}function c(v){if(v&&v.isTexture){const b=v.mapping;if(b===Cd||b===wd)if(e.has(v)){const E=e.get(v).texture;return p(E,v.mapping)}else{const E=v.image;if(E&&E.height>0){const C=new _x(E.height);return C.fromEquirectangularTexture(r,v),e.set(v,C),v.addEventListener("dispose",h),p(C.texture,v.mapping)}else return null}}return v}function f(v){if(v&&v.isTexture){const b=v.mapping,E=b===Cd||b===wd,C=b===Vr||b===ks;if(E||C){let y=i.get(v);const S=y!==void 0?y.texture.pmremVersion:0;if(v.isRenderTargetTexture&&v.pmremVersion!==S)return s===null&&(s=new t_(r)),y=E?s.fromEquirectangular(v,y):s.fromCubemap(v,y),y.texture.pmremVersion=v.pmremVersion,i.set(v,y),y.texture;if(y!==void 0)return y.texture;{const w=v.image;return E&&w&&w.height>0||C&&w&&m(w)?(s===null&&(s=new t_(r)),y=E?s.fromEquirectangular(v):s.fromCubemap(v),y.texture.pmremVersion=v.pmremVersion,i.set(v,y),v.addEventListener("dispose",_),y.texture):null}}}return v}function p(v,b){return b===Cd?v.mapping=Vr:b===wd&&(v.mapping=ks),v}function m(v){let b=0;const E=6;for(let C=0;C<E;C++)v[C]!==void 0&&b++;return b===E}function h(v){const b=v.target;b.removeEventListener("dispose",h);const E=e.get(b);E!==void 0&&(e.delete(b),E.dispose())}function _(v){const b=v.target;b.removeEventListener("dispose",_);const E=i.get(b);E!==void 0&&(i.delete(b),E.dispose())}function g(){e=new WeakMap,i=new WeakMap,s!==null&&(s.dispose(),s=null)}return{get:l,dispose:g}}function UA(r){const e={};function i(s){if(e[s]!==void 0)return e[s];const l=r.getExtension(s);return e[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&Kh("WebGLRenderer: "+s+" extension not supported."),l}}}function NA(r,e,i,s){const l={},c=new WeakMap;function f(g){const v=g.target;v.index!==null&&e.remove(v.index);for(const E in v.attributes)e.remove(v.attributes[E]);v.removeEventListener("dispose",f),delete l[v.id];const b=c.get(v);b&&(e.remove(b),c.delete(v)),s.releaseStatesOfGeometry(v),v.isInstancedBufferGeometry===!0&&delete v._maxInstanceCount,i.memory.geometries--}function p(g,v){return l[v.id]===!0||(v.addEventListener("dispose",f),l[v.id]=!0,i.memory.geometries++),v}function m(g){const v=g.attributes;for(const b in v)e.update(v[b],r.ARRAY_BUFFER)}function h(g){const v=[],b=g.index,E=g.attributes.position;let C=0;if(E===void 0)return;if(b!==null){const w=b.array;C=b.version;for(let N=0,O=w.length;N<O;N+=3){const V=w[N+0],F=w[N+1],z=w[N+2];v.push(V,F,F,z,z,V)}}else{const w=E.array;C=E.version;for(let N=0,O=w.length/3-1;N<O;N+=3){const V=N+0,F=N+1,z=N+2;v.push(V,F,F,z,z,V)}}const y=new(E.count>=65535?cx:lx)(v,1);y.version=C;const S=c.get(g);S&&e.remove(S),c.set(g,y)}function _(g){const v=c.get(g);if(v){const b=g.index;b!==null&&v.version<b.version&&h(g)}else h(g);return c.get(g)}return{get:p,update:m,getWireframeAttribute:_}}function LA(r,e,i){let s;function l(g){s=g}let c,f;function p(g){c=g.type,f=g.bytesPerElement}function m(g,v){r.drawElements(s,v,c,g*f),i.update(v,s,1)}function h(g,v,b){b!==0&&(r.drawElementsInstanced(s,v,c,g*f,b),i.update(v,s,b))}function _(g,v,b){if(b===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,v,0,c,g,0,b);let C=0;for(let y=0;y<b;y++)C+=v[y];i.update(C,s,1)}this.setMode=l,this.setIndex=p,this.render=m,this.renderInstances=h,this.renderMultiDraw=_}function OA(r){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,f,p){switch(i.calls++,f){case r.TRIANGLES:i.triangles+=p*(c/3);break;case r.LINES:i.lines+=p*(c/2);break;case r.LINE_STRIP:i.lines+=p*(c-1);break;case r.LINE_LOOP:i.lines+=p*c;break;case r.POINTS:i.points+=p*c;break;default:Et("WebGLInfo: Unknown draw mode:",f);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:s}}function PA(r,e,i){const s=new WeakMap,l=new sn;function c(f,p,m){const h=f.morphTargetInfluences,_=p.morphAttributes.position||p.morphAttributes.normal||p.morphAttributes.color,g=_!==void 0?_.length:0;let v=s.get(p);if(v===void 0||v.count!==g){let j=function(){T.dispose(),s.delete(p),p.removeEventListener("dispose",j)};var b=j;v!==void 0&&v.texture.dispose();const E=p.morphAttributes.position!==void 0,C=p.morphAttributes.normal!==void 0,y=p.morphAttributes.color!==void 0,S=p.morphAttributes.position||[],w=p.morphAttributes.normal||[],N=p.morphAttributes.color||[];let O=0;E===!0&&(O=1),C===!0&&(O=2),y===!0&&(O=3);let V=p.attributes.position.count*O,F=1;V>e.maxTextureSize&&(F=Math.ceil(V/e.maxTextureSize),V=e.maxTextureSize);const z=new Float32Array(V*F*4*g),T=new rx(z,V,F,g);T.type=Wi,T.needsUpdate=!0;const B=O*4;for(let G=0;G<g;G++){const K=S[G],ue=w[G],pe=N[G],X=V*F*4*G;for(let L=0;L<K.count;L++){const I=L*B;E===!0&&(l.fromBufferAttribute(K,L),z[X+I+0]=l.x,z[X+I+1]=l.y,z[X+I+2]=l.z,z[X+I+3]=0),C===!0&&(l.fromBufferAttribute(ue,L),z[X+I+4]=l.x,z[X+I+5]=l.y,z[X+I+6]=l.z,z[X+I+7]=0),y===!0&&(l.fromBufferAttribute(pe,L),z[X+I+8]=l.x,z[X+I+9]=l.y,z[X+I+10]=l.z,z[X+I+11]=pe.itemSize===4?l.w:1)}}v={count:g,texture:T,size:new Nt(V,F)},s.set(p,v),p.addEventListener("dispose",j)}if(f.isInstancedMesh===!0&&f.morphTexture!==null)m.getUniforms().setValue(r,"morphTexture",f.morphTexture,i);else{let E=0;for(let y=0;y<h.length;y++)E+=h[y];const C=p.morphTargetsRelative?1:1-E;m.getUniforms().setValue(r,"morphTargetBaseInfluence",C),m.getUniforms().setValue(r,"morphTargetInfluences",h)}m.getUniforms().setValue(r,"morphTargetsTexture",v.texture,i),m.getUniforms().setValue(r,"morphTargetsTextureSize",v.size)}return{update:c}}function FA(r,e,i,s,l){let c=new WeakMap;function f(h){const _=l.render.frame,g=h.geometry,v=e.get(h,g);if(c.get(v)!==_&&(e.update(v),c.set(v,_)),h.isInstancedMesh&&(h.hasEventListener("dispose",m)===!1&&h.addEventListener("dispose",m),c.get(h)!==_&&(i.update(h.instanceMatrix,r.ARRAY_BUFFER),h.instanceColor!==null&&i.update(h.instanceColor,r.ARRAY_BUFFER),c.set(h,_))),h.isSkinnedMesh){const b=h.skeleton;c.get(b)!==_&&(b.update(),c.set(b,_))}return v}function p(){c=new WeakMap}function m(h){const _=h.target;_.removeEventListener("dispose",m),s.releaseStatesOfObject(_),i.remove(_.instanceMatrix),_.instanceColor!==null&&i.remove(_.instanceColor)}return{update:f,dispose:p}}const BA={[k_]:"LINEAR_TONE_MAPPING",[W_]:"REINHARD_TONE_MAPPING",[X_]:"CINEON_TONE_MAPPING",[j_]:"ACES_FILMIC_TONE_MAPPING",[Y_]:"AGX_TONE_MAPPING",[Z_]:"NEUTRAL_TONE_MAPPING",[q_]:"CUSTOM_TONE_MAPPING"};function zA(r,e,i,s,l){const c=new qi(e,i,{type:r,depthBuffer:s,stencilBuffer:l,depthTexture:s?new Ws(e,i):void 0}),f=new qi(e,i,{type:Aa,depthBuffer:!1,stencilBuffer:!1}),p=new wa;p.setAttribute("position",new Ea([-1,3,0,-1,-1,0,3,-1,0],3)),p.setAttribute("uv",new Ea([0,2,0,0,2,0],2));const m=new CE({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`].filter($o).join(`
`)),f=$h(f),f=p_(f,i),f=m_(f,i),p=$h(p),p=p_(p,i),p=m_(p,i),f=g_(f),p=g_(p),i.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
}`,vC=[new ie(1,0,0),new ie(-1,0,0),new ie(0,1,0),new ie(0,-1,0),new ie(0,0,1),new ie(0,0,-1)],_C=[new ie(0,-1,0),new ie(0,-1,0),new ie(0,0,1),new ie(0,0,-1),new ie(0,-1,0),new ie(0,-1,0)],S_=new fn,Qo=new ie,oh=new ie;function xC(r,e,i){let s=new yp;const l=new Nt,c=new Nt,f=new sn,p=new wE,m=new DE,h={},_=i.maxTextureSize,g={[hr]:Zn,[Zn]:hr,[ki]:ki},v=new Oi({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Nt},radius:{value:4}},vertexShader:mC,fragmentShader:gC}),b=v.clone();b.defines.HORIZONTAL_PASS=1;const E=new wa;E.setAttribute("position",new Yi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const C=new Ki(E,v),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Zc;let S=this.type;this.render=function(F,z,T){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||F.length===0)return;this.type===vM&&(nt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Zc);const B=r.getRenderTarget(),j=r.getActiveCubeFace(),G=r.getActiveMipmapLevel(),K=r.state;K.setBlending(ba),K.buffers.depth.getReversed()===!0?K.buffers.color.setClear(0,0,0,0):K.buffers.color.setClear(1,1,1,1),K.buffers.depth.setTest(!0),K.setScissorTest(!1);const ue=S!==this.type;ue&&z.traverse(function(pe){pe.material&&(Array.isArray(pe.material)?pe.material.forEach(X=>X.needsUpdate=!0):pe.material.needsUpdate=!0)});for(let pe=0,X=F.length;pe<X;pe++){const L=F[pe],I=L.shadow;if(I===void 0){nt("WebGLShadowMap:",L,"has no shadow.");continue}if(I.autoUpdate===!1&&I.needsUpdate===!1)continue;l.copy(I.mapSize);const se=I.getFrameExtents();l.multiply(se),c.copy(I.mapSize),(l.x>_||l.y>_)&&(l.x>_&&(c.x=Math.floor(_/se.x),l.x=c.x*se.x,I.mapSize.x=c.x),l.y>_&&(c.y=Math.floor(_/se.y),l.y=c.y*se.y,I.mapSize.y=c.y));const ge=r.state.buffers.depth.getReversed();if(I.camera._reversedDepth=ge,I.map===null||ue===!0){if(I.map!==null&&(I.map.depthTexture!==null&&(I.map.depthTexture.dispose(),I.map.depthTexture=null),I.map.dispose()),this.type===Jo){if(L.isPointLight){nt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}I.map=new qi(l.x,l.y,{format:kr,type:Aa,minFilter:Bn,magFilter:Bn,generateMipmaps:!1}),I.map.texture.name=L.name+".shadowMap",I.map.depthTexture=new Ws(l.x,l.y,Wi),I.map.depthTexture.name=L.name+".shadowMapDepth",I.map.depthTexture.format=Ra,I.map.depthTexture.compareFunction=null,I.map.depthTexture.minFilter=Un,I.map.depthTexture.magFilter=Un}else L.isPointLight?(I.map=new _x(l.x),I.map.depthTexture=new ME(l.x,Zi)):(I.map=new qi(l.x,l.y),I.map.depthTexture=new Ws(l.x,l.y,Zi)),I.map.depthTexture.name=L.name+".shadowMap",I.map.depthTexture.format=Ra,this.type===Zc?(I.map.depthTexture.compareFunction=ge?vp:gp,I.map.depthTexture.minFilter=Bn,I.map.depthTexture.magFilter=Bn):(I.map.depthTexture.compareFunction=null,I.map.depthTexture.minFilter=Un,I.map.depthTexture.magFilter=Un);I.camera.updateProjectionMatrix()}const Se=I.map.isWebGLCubeRenderTarget?6:1;for(let P=0;P<Se;P++){if(I.map.isWebGLCubeRenderTarget)r.setRenderTarget(I.map,P),r.clear();else{P===0&&(r.setRenderTarget(I.map),r.clear());const Q=I.getViewport(P);f.set(c.x*Q.x,c.y*Q.y,c.x*Q.z,c.y*Q.w),K.viewport(f)}if(L.isPointLight){const Q=I.camera,ye=I.matrix,Re=L.distance||Q.far;Re!==Q.far&&(Q.far=Re,Q.updateProjectionMatrix()),Qo.setFromMatrixPosition(L.matrixWorld),Q.position.copy(Qo),oh.copy(Q.position),oh.add(vC[P]),Q.up.copy(_C[P]),Q.lookAt(oh),Q.updateMatrixWorld(),ye.makeTranslation(-Qo.x,-Qo.y,-Qo.z),S_.multiplyMatrices(Q.projectionMatrix,Q.matrixWorldInverse),I._frustum.setFromProjectionMatrix(S_,Q.coordinateSystem,Q.reversedDepth)}else I.updateMatrices(L);s=I.getFrustum(),O(z,T,I.camera,L,this.type)}I.isPointLightShadow!==!0&&this.type===Jo&&w(I,T),I.needsUpdate=!1}S=this.type,y.needsUpdate=!1,r.setRenderTarget(B,j,G)};function w(F,z){const T=e.update(C);v.defines.VSM_SAMPLES!==F.blurSamples&&(v.defines.VSM_SAMPLES=F.blurSamples,b.defines.VSM_SAMPLES=F.blurSamples,v.needsUpdate=!0,b.needsUpdate=!0),F.mapPass===null&&(F.mapPass=new qi(l.x,l.y,{format:kr,type:Aa})),v.uniforms.shadow_pass.value=F.map.depthTexture,v.uniforms.resolution.value=F.mapSize,v.uniforms.radius.value=F.radius,r.setRenderTarget(F.mapPass),r.clear(),r.renderBufferDirect(z,null,T,v,C,null),b.uniforms.shadow_pass.value=F.mapPass.texture,b.uniforms.resolution.value=F.mapSize,b.uniforms.radius.value=F.radius,r.setRenderTarget(F.map),r.clear(),r.renderBufferDirect(z,null,T,b,C,null)}function N(F,z,T,B){let j=null;const G=T.isPointLight===!0?F.customDistanceMaterial:F.customDepthMaterial;if(G!==void 0)j=G;else if(j=T.isPointLight===!0?m:p,r.localClippingEnabled&&z.clipShadows===!0&&Array.isArray(z.clippingPlanes)&&z.clippingPlanes.length!==0||z.displacementMap&&z.displacementScale!==0||z.alphaMap&&z.alphaTest>0||z.map&&z.alphaTest>0||z.alphaToCoverage===!0){const K=j.uuid,ue=z.uuid;let pe=h[K];pe===void 0&&(pe={},h[K]=pe);let X=pe[ue];X===void 0&&(X=j.clone(),pe[ue]=X,z.addEventListener("dispose",V)),j=X}if(j.visible=z.visible,j.wireframe=z.wireframe,B===Jo?j.side=z.shadowSide!==null?z.shadowSide:z.side:j.side=z.shadowSide!==null?z.shadowSide:g[z.side],j.alphaMap=z.alphaMap,j.alphaTest=z.alphaToCoverage===!0?.5:z.alphaTest,j.map=z.map,j.clipShadows=z.clipShadows,j.clippingPlanes=z.clippingPlanes,j.clipIntersection=z.clipIntersection,j.displacementMap=z.displacementMap,j.displacementScale=z.displacementScale,j.displacementBias=z.displacementBias,j.wireframeLinewidth=z.wireframeLinewidth,j.linewidth=z.linewidth,T.isPointLight===!0&&j.isMeshDistanceMaterial===!0){const K=r.properties.get(j);K.light=T}return j}function O(F,z,T,B,j){if(F.visible===!1)return;if(F.layers.test(z.layers)&&(F.isMesh||F.isLine||F.isPoints)&&(F.castShadow||F.receiveShadow&&j===Jo)&&(!F.frustumCulled||s.intersectsObject(F))){F.modelViewMatrix.multiplyMatrices(T.matrixWorldInverse,F.matrixWorld);const ue=e.update(F),pe=F.material;if(Array.isArray(pe)){const X=ue.groups;for(let L=0,I=X.length;L<I;L++){const se=X[L],ge=pe[se.materialIndex];if(ge&&ge.visible){const Se=N(F,ge,B,j);F.onBeforeShadow(r,F,z,T,ue,Se,se),r.renderBufferDirect(T,null,ue,Se,F,se),F.onAfterShadow(r,F,z,T,ue,Se,se)}}}else if(pe.visible){const X=N(F,pe,B,j);F.onBeforeShadow(r,F,z,T,ue,X,null),r.renderBufferDirect(T,null,ue,X,F,null),F.onAfterShadow(r,F,z,T,ue,X,null)}}const K=F.children;for(let ue=0,pe=K.length;ue<pe;ue++)O(K[ue],z,T,B,j)}function V(F){F.target.removeEventListener("dispose",V);for(const T in h){const B=h[T],j=F.target.uuid;j in B&&(B[j].dispose(),delete B[j])}}}function yC(r,e){function i(){let k=!1;const Ae=new sn;let me=null;const Ie=new sn(0,0,0,0);return{setMask:function(Le){me!==Le&&!k&&(r.colorMask(Le,Le,Le,Le),me=Le)},setLocked:function(Le){k=Le},setClear:function(Le,Me,qe,tt,tn){tn===!0&&(Le*=tt,Me*=tt,qe*=tt),Ae.set(Le,Me,qe,tt),Ie.equals(Ae)===!1&&(r.clearColor(Le,Me,qe,tt),Ie.copy(Ae))},reset:function(){k=!1,me=null,Ie.set(-1,0,0,0)}}}function s(){let k=!1,Ae=!1,me=null,Ie=null,Le=null;return{setReversed:function(Me){if(Ae!==Me){const qe=e.get("EXT_clip_control");Me?qe.clipControlEXT(qe.LOWER_LEFT_EXT,qe.ZERO_TO_ONE_EXT):qe.clipControlEXT(qe.LOWER_LEFT_EXT,qe.NEGATIVE_ONE_TO_ONE_EXT),Ae=Me;const tt=Le;Le=null,this.setClear(tt)}},getReversed:function(){return Ae},setTest:function(Me){Me?Te(r.DEPTH_TEST):Ge(r.DEPTH_TEST)},setMask:function(Me){me!==Me&&!k&&(r.depthMask(Me),me=Me)},setFunc:function(Me){if(Ae&&(Me=KM[Me]),Ie!==Me){switch(Me){case dh:r.depthFunc(r.NEVER);break;case hh:r.depthFunc(r.ALWAYS);break;case ph:r.depthFunc(r.LESS);break;case Vs:r.depthFunc(r.LEQUAL);break;case mh:r.depthFunc(r.EQUAL);break;case gh:r.depthFunc(r.GEQUAL);break;case vh:r.depthFunc(r.GREATER);break;case _h:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}Ie=Me}},setLocked:function(Me){k=Me},setClear:function(Me){Le!==Me&&(Le=Me,Ae&&(Me=1-Me),r.clearDepth(Me))},reset:function(){k=!1,me=null,Ie=null,Le=null,Ae=!1}}}function l(){let k=!1,Ae=null,me=null,Ie=null,Le=null,Me=null,qe=null,tt=null,tn=null;return{setTest:function(wt){k||(wt?Te(r.STENCIL_TEST):Ge(r.STENCIL_TEST))},setMask:function(wt){Ae!==wt&&!k&&(r.stencilMask(wt),Ae=wt)},setFunc:function(wt,ci,Kn){(me!==wt||Ie!==ci||Le!==Kn)&&(r.stencilFunc(wt,ci,Kn),me=wt,Ie=ci,Le=Kn)},setOp:function(wt,ci,Kn){(Me!==wt||qe!==ci||tt!==Kn)&&(r.stencilOp(wt,ci,Kn),Me=wt,qe=ci,tt=Kn)},setLocked:function(wt){k=wt},setClear:function(wt){tn!==wt&&(r.clearStencil(wt),tn=wt)},reset:function(){k=!1,Ae=null,me=null,Ie=null,Le=null,Me=null,qe=null,tt=null,tn=null}}}const c=new i,f=new s,p=new l,m=new WeakMap,h=new WeakMap;let _={},g={},v={},b=new WeakMap,E=[],C=null,y=!1,S=null,w=null,N=null,O=null,V=null,F=null,z=null,T=new Ct(0,0,0),B=0,j=!1,G=null,K=null,ue=null,pe=null,X=null;const L=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let I=!1,se=0;const ge=r.getParameter(r.VERSION);ge.indexOf("WebGL")!==-1?(se=parseFloat(/^WebGL (\d)/.exec(ge)[1]),I=se>=1):ge.indexOf("OpenGL ES")!==-1&&(se=parseFloat(/^OpenGL ES (\d)/.exec(ge)[1]),I=se>=2);let Se=null,P={};const Q=r.getParameter(r.SCISSOR_BOX),ye=r.getParameter(r.VIEWPORT),Re=new sn().fromArray(Q),Ue=new sn().fromArray(ye);function oe(k,Ae,me,Ie){const Le=new Uint8Array(4),Me=r.createTexture();r.bindTexture(k,Me),r.texParameteri(k,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(k,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let qe=0;qe<me;qe++)k===r.TEXTURE_3D||k===r.TEXTURE_2D_ARRAY?r.texImage3D(Ae,0,r.RGBA,1,1,Ie,0,r.RGBA,r.UNSIGNED_BYTE,Le):r.texImage2D(Ae+qe,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,Le);return Me}const be={};be[r.TEXTURE_2D]=oe(r.TEXTURE_2D,r.TEXTURE_2D,1),be[r.TEXTURE_CUBE_MAP]=oe(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),be[r.TEXTURE_2D_ARRAY]=oe(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),be[r.TEXTURE_3D]=oe(r.TEXTURE_3D,r.TEXTURE_3D,1,1),c.setClear(0,0,0,1),f.setClear(1),p.setClear(0),Te(r.DEPTH_TEST),f.setFunc(Vs),on(!1),qt(bv),Te(r.CULL_FACE),Lt(ba);function Te(k){_[k]!==!0&&(r.enable(k),_[k]=!0)}function Ge(k){_[k]!==!1&&(r.disable(k),_[k]=!1)}function et(k,Ae){return v[k]!==Ae?(r.bindFramebuffer(k,Ae),v[k]=Ae,k===r.DRAW_FRAMEBUFFER&&(v[r.FRAMEBUFFER]=Ae),k===r.FRAMEBUFFER&&(v[r.DRAW_FRAMEBUFFER]=Ae),!0):!1}function Je(k,Ae){let me=E,Ie=!1;if(k){me=b.get(Ae),me===void 0&&(me=[],b.set(Ae,me));const Le=k.textures;if(me.length!==Le.length||me[0]!==r.COLOR_ATTACHMENT0){for(let Me=0,qe=Le.length;Me<qe;Me++)me[Me]=r.COLOR_ATTACHMENT0+Me;me.length=Le.length,Ie=!0}}else me[0]!==r.BACK&&(me[0]=r.BACK,Ie=!0);Ie&&r.drawBuffers(me)}function Wt(k){return C!==k?(r.useProgram(k),C=k,!0):!1}const dt={[zr]:r.FUNC_ADD,[xM]:r.FUNC_SUBTRACT,[yM]:r.FUNC_REVERSE_SUBTRACT};dt[SM]=r.MIN,dt[bM]=r.MAX;const _t={[MM]:r.ZERO,[EM]:r.ONE,[TM]:r.SRC_COLOR,[uh]:r.SRC_ALPHA,[UM]:r.SRC_ALPHA_SATURATE,[wM]:r.DST_COLOR,[RM]:r.DST_ALPHA,[AM]:r.ONE_MINUS_SRC_COLOR,[fh]:r.ONE_MINUS_SRC_ALPHA,[DM]:r.ONE_MINUS_DST_COLOR,[CM]:r.ONE_MINUS_DST_ALPHA,[NM]:r.CONSTANT_COLOR,[LM]:r.ONE_MINUS_CONSTANT_COLOR,[OM]:r.CONSTANT_ALPHA,[PM]:r.ONE_MINUS_CONSTANT_ALPHA};function Lt(k,Ae,me,Ie,Le,Me,qe,tt,tn,wt){if(k===ba){y===!0&&(Ge(r.BLEND),y=!1);return}if(y===!1&&(Te(r.BLEND),y=!0),k!==_M){if(k!==S||wt!==j){if((w!==zr||V!==zr)&&(r.blendEquation(r.FUNC_ADD),w=zr,V=zr),wt)switch(k){case Hs:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Mv:r.blendFunc(r.ONE,r.ONE);break;case Ev:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case Tv:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:Et("WebGLState: Invalid blending: ",k);break}else switch(k){case Hs:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Mv:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case Ev:Et("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Tv:Et("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Et("WebGLState: Invalid blending: ",k);break}N=null,O=null,F=null,z=null,T.set(0,0,0),B=0,S=k,j=wt}return}Le=Le||Ae,Me=Me||me,qe=qe||Ie,(Ae!==w||Le!==V)&&(r.blendEquationSeparate(dt[Ae],dt[Le]),w=Ae,V=Le),(me!==N||Ie!==O||Me!==F||qe!==z)&&(r.blendFuncSeparate(_t[me],_t[Ie],_t[Me],_t[qe]),N=me,O=Ie,F=Me,z=qe),(tt.equals(T)===!1||tn!==B)&&(r.blendColor(tt.r,tt.g,tt.b,tn),T.copy(tt),B=tn),S=k,j=!1}function ct(k,Ae){k.side===ki?Ge(r.CULL_FACE):Te(r.CULL_FACE);let me=k.side===Zn;Ae&&(me=!me),on(me),k.blending===Hs&&k.transparent===!1?Lt(ba):Lt(k.blending,k.blendEquation,k.blendSrc,k.blendDst,k.blendEquationAlpha,k.blendSrcAlpha,k.blendDstAlpha,k.blendColor,k.blendAlpha,k.premultipliedAlpha),f.setFunc(k.depthFunc),f.setTest(k.depthTest),f.setMask(k.depthWrite),c.setMask(k.colorWrite);const Ie=k.stencilWrite;p.setTest(Ie),Ie&&(p.setMask(k.stencilWriteMask),p.setFunc(k.stencilFunc,k.stencilRef,k.stencilFuncMask),p.setOp(k.stencilFail,k.stencilZFail,k.stencilZPass)),q(k.polygonOffset,k.polygonOffsetFactor,k.polygonOffsetUnits),k.alphaToCoverage===!0?Te(r.SAMPLE_ALPHA_TO_COVERAGE):Ge(r.SAMPLE_ALPHA_TO_COVERAGE)}function on(k){G!==k&&(k?r.frontFace(r.CW):r.frontFace(r.CCW),G=k)}function qt(k){k!==mM?(Te(r.CULL_FACE),k!==K&&(k===bv?r.cullFace(r.BACK):k===gM?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Ge(r.CULL_FACE),K=k}function Tn(k){k!==ue&&(I&&r.lineWidth(k),ue=k)}function q(k,Ae,me){k?(Te(r.POLYGON_OFFSET_FILL),(pe!==Ae||X!==me)&&(pe=Ae,X=me,f.getReversed()&&(Ae=-Ae),r.polygonOffset(Ae,me))):Ge(r.POLYGON_OFFSET_FILL)}function en(k){k?Te(r.SCISSOR_TEST):Ge(r.SCISSOR_TEST)}function ht(k){k===void 0&&(k=r.TEXTURE0+L-1),Se!==k&&(r.activeTexture(k),Se=k)}function Ht(k,Ae,me){me===void 0&&(Se===null?me=r.TEXTURE0+L-1:me=Se);let Ie=P[me];Ie===void 0&&(Ie={type:void 0,texture:void 0},P[me]=Ie),(Ie.type!==k||Ie.texture!==Ae)&&(Se!==me&&(r.activeTexture(me),Se=me),r.bindTexture(k,Ae||be[k]),Ie.type=k,Ie.texture=Ae)}function Ce(){const k=P[Se];k!==void 0&&k.type!==void 0&&(r.bindTexture(k.type,null),k.type=void 0,k.texture=void 0)}function Kt(){try{r.compressedTexImage2D(...arguments)}catch(k){Et("WebGLState:",k)}}function U(){try{r.compressedTexImage3D(...arguments)}catch(k){Et("WebGLState:",k)}}function M(){try{r.texSubImage2D(...arguments)}catch(k){Et("WebGLState:",k)}}function J(){try{r.texSubImage3D(...arguments)}catch(k){Et("WebGLState:",k)}}function _e(){try{r.compressedTexSubImage2D(...arguments)}catch(k){Et("WebGLState:",k)}}function Ee(){try{r.compressedTexSubImage3D(...arguments)}catch(k){Et("WebGLState:",k)}}function we(){try{r.texStorage2D(...arguments)}catch(k){Et("WebGLState:",k)}}function Oe(){try{r.texStorage3D(...arguments)}catch(k){Et("WebGLState:",k)}}function fe(){try{r.texImage2D(...arguments)}catch(k){Et("WebGLState:",k)}}function de(){try{r.texImage3D(...arguments)}catch(k){Et("WebGLState:",k)}}function Pe(k){return g[k]!==void 0?g[k]:r.getParameter(k)}function Fe(k,Ae){g[k]!==Ae&&(r.pixelStorei(k,Ae),g[k]=Ae)}function Ne(k){Re.equals(k)===!1&&(r.scissor(k.x,k.y,k.z,k.w),Re.copy(k))}function De(k){Ue.equals(k)===!1&&(r.viewport(k.x,k.y,k.z,k.w),Ue.copy(k))}function it(k,Ae){let me=h.get(Ae);me===void 0&&(me=new WeakMap,h.set(Ae,me));let Ie=me.get(k);Ie===void 0&&(Ie=r.getUniformBlockIndex(Ae,k.name),me.set(k,Ie))}function at(k,Ae){const Ie=h.get(Ae).get(k);m.get(Ae)!==Ie&&(r.uniformBlockBinding(Ae,Ie,k.__bindingPointIndex),m.set(Ae,Ie))}function pt(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),f.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),r.pixelStorei(r.PACK_ALIGNMENT,4),r.pixelStorei(r.UNPACK_ALIGNMENT,4),r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,!1),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,r.BROWSER_DEFAULT_WEBGL),r.pixelStorei(r.PACK_ROW_LENGTH,0),r.pixelStorei(r.PACK_SKIP_PIXELS,0),r.pixelStorei(r.PACK_SKIP_ROWS,0),r.pixelStorei(r.UNPACK_ROW_LENGTH,0),r.pixelStorei(r.UNPACK_IMAGE_HEIGHT,0),r.pixelStorei(r.UNPACK_SKIP_PIXELS,0),r.pixelStorei(r.UNPACK_SKIP_ROWS,0),r.pixelStorei(r.UNPACK_SKIP_IMAGES,0),_={},g={},Se=null,P={},v={},b=new WeakMap,E=[],C=null,y=!1,S=null,w=null,N=null,O=null,V=null,F=null,z=null,T=new Ct(0,0,0),B=0,j=!1,G=null,K=null,ue=null,pe=null,X=null,Re.set(0,0,r.canvas.width,r.canvas.height),Ue.set(0,0,r.canvas.width,r.canvas.height),c.reset(),f.reset(),p.reset()}return{buffers:{color:c,depth:f,stencil:p},enable:Te,disable:Ge,bindFramebuffer:et,drawBuffers:Je,useProgram:Wt,setBlending:Lt,setMaterial:ct,setFlipSided:on,setCullFace:qt,setLineWidth:Tn,setPolygonOffset:q,setScissorTest:en,activeTexture:ht,bindTexture:Ht,unbindTexture:Ce,compressedTexImage2D:Kt,compressedTexImage3D:U,texImage2D:fe,texImage3D:de,pixelStorei:Fe,getParameter:Pe,updateUBOMapping:it,uniformBlockBinding:at,texStorage2D:we,texStorage3D:Oe,texSubImage2D:M,texSubImage3D:J,compressedTexSubImage2D:_e,compressedTexSubImage3D:Ee,scissor:Ne,viewport:De,reset:pt}}function SC(r,e,i,s,l,c,f){const p=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),h=new Nt,_=new WeakMap,g=new Set;let v;const b=new WeakMap;let E=!1;try{E=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function C(U,M){return E?new OffscreenCanvas(U,M):ou("canvas")}function y(U,M,J){let _e=1;const Ee=Kt(U);if((Ee.width>J||Ee.height>J)&&(_e=J/Math.max(Ee.width,Ee.height)),_e<1)if(typeof HTMLImageElement<"u"&&U instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&U instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&U instanceof ImageBitmap||typeof VideoFrame<"u"&&U instanceof VideoFrame){const we=Math.floor(_e*Ee.width),Oe=Math.floor(_e*Ee.height);v===void 0&&(v=C(we,Oe));const fe=M?C(we,Oe):v;return fe.width=we,fe.height=Oe,fe.getContext("2d").drawImage(U,0,0,we,Oe),nt("WebGLRenderer: Texture has been resized from ("+Ee.width+"x"+Ee.height+") to ("+we+"x"+Oe+")."),fe}else return"data"in U&&nt("WebGLRenderer: Image in DataTexture is too big ("+Ee.width+"x"+Ee.height+")."),U;return U}function S(U){return U.generateMipmaps}function w(U){r.generateMipmap(U)}function N(U){return U.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:U.isWebGL3DRenderTarget?r.TEXTURE_3D:U.isWebGLArrayRenderTarget||U.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function O(U,M,J,_e,Ee,we=!1){if(U!==null){if(r[U]!==void 0)return r[U];nt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+U+"'")}let Oe;_e&&(Oe=e.get("EXT_texture_norm16"),Oe||nt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let fe=M;if(M===r.RED&&(J===r.FLOAT&&(fe=r.R32F),J===r.HALF_FLOAT&&(fe=r.R16F),J===r.UNSIGNED_BYTE&&(fe=r.R8),J===r.UNSIGNED_SHORT&&Oe&&(fe=Oe.R16_EXT),J===r.SHORT&&Oe&&(fe=Oe.R16_SNORM_EXT)),M===r.RED_INTEGER&&(J===r.UNSIGNED_BYTE&&(fe=r.R8UI),J===r.UNSIGNED_SHORT&&(fe=r.R16UI),J===r.UNSIGNED_INT&&(fe=r.R32UI),J===r.BYTE&&(fe=r.R8I),J===r.SHORT&&(fe=r.R16I),J===r.INT&&(fe=r.R32I)),M===r.RG&&(J===r.FLOAT&&(fe=r.RG32F),J===r.HALF_FLOAT&&(fe=r.RG16F),J===r.UNSIGNED_BYTE&&(fe=r.RG8),J===r.UNSIGNED_SHORT&&Oe&&(fe=Oe.RG16_EXT),J===r.SHORT&&Oe&&(fe=Oe.RG16_SNORM_EXT)),M===r.RG_INTEGER&&(J===r.UNSIGNED_BYTE&&(fe=r.RG8UI),J===r.UNSIGNED_SHORT&&(fe=r.RG16UI),J===r.UNSIGNED_INT&&(fe=r.RG32UI),J===r.BYTE&&(fe=r.RG8I),J===r.SHORT&&(fe=r.RG16I),J===r.INT&&(fe=r.RG32I)),M===r.RGB_INTEGER&&(J===r.UNSIGNED_BYTE&&(fe=r.RGB8UI),J===r.UNSIGNED_SHORT&&(fe=r.RGB16UI),J===r.UNSIGNED_INT&&(fe=r.RGB32UI),J===r.BYTE&&(fe=r.RGB8I),J===r.SHORT&&(fe=r.RGB16I),J===r.INT&&(fe=r.RGB32I)),M===r.RGBA_INTEGER&&(J===r.UNSIGNED_BYTE&&(fe=r.RGBA8UI),J===r.UNSIGNED_SHORT&&(fe=r.RGBA16UI),J===r.UNSIGNED_INT&&(fe=r.RGBA32UI),J===r.BYTE&&(fe=r.RGBA8I),J===r.SHORT&&(fe=r.RGBA16I),J===r.INT&&(fe=r.RGBA32I)),M===r.RGB&&(J===r.UNSIGNED_SHORT&&Oe&&(fe=Oe.RGB16_EXT),J===r.SHORT&&Oe&&(fe=Oe.RGB16_SNORM_EXT),J===r.UNSIGNED_INT_5_9_9_9_REV&&(fe=r.RGB9_E5),J===r.UNSIGNED_INT_10F_11F_11F_REV&&(fe=r.R11F_G11F_B10F)),M===r.RGBA){const de=we?su:bt.getTransfer(Ee);J===r.FLOAT&&(fe=r.RGBA32F),J===r.HALF_FLOAT&&(fe=r.RGBA16F),J===r.UNSIGNED_BYTE&&(fe=de===It?r.SRGB8_ALPHA8:r.RGBA8),J===r.UNSIGNED_SHORT&&Oe&&(fe=Oe.RGBA16_EXT),J===r.SHORT&&Oe&&(fe=Oe.RGBA16_SNORM_EXT),J===r.UNSIGNED_SHORT_4_4_4_4&&(fe=r.RGBA4),J===r.UNSIGNED_SHORT_5_5_5_1&&(fe=r.RGB5_A1)}return(fe===r.R16F||fe===r.R32F||fe===r.RG16F||fe===r.RG32F||fe===r.RGBA16F||fe===r.RGBA32F)&&e.get("EXT_color_buffer_float"),fe}function V(U,M){let J;return U?M===null||M===Zi||M===il?J=r.DEPTH24_STENCIL8:M===Wi?J=r.DEPTH32F_STENCIL8:M===nl&&(J=r.DEPTH24_STENCIL8,nt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Zi||M===il?J=r.DEPTH_COMPONENT24:M===Wi?J=r.DEPTH_COMPONENT32F:M===nl&&(J=r.DEPTH_COMPONENT16),J}function F(U,M){return S(U)===!0||U.isFramebufferTexture&&U.minFilter!==Un&&U.minFilter!==Bn?Math.log2(Math.max(M.width,M.height))+1:U.mipmaps!==void 0&&U.mipmaps.length>0?U.mipmaps.length:U.isCompressedTexture&&Array.isArray(U.image)?M.mipmaps.length:1}function z(U){const M=U.target;M.removeEventListener("dispose",z),B(M),M.isVideoTexture&&_.delete(M),M.isHTMLTexture&&g.delete(M)}function T(U){const M=U.target;M.removeEventListener("dispose",T),G(M)}function B(U){const M=s.get(U);if(M.__webglInit===void 0)return;const J=U.source,_e=b.get(J);if(_e){const Ee=_e[M.__cacheKey];Ee.usedTimes--,Ee.usedTimes===0&&j(U),Object.keys(_e).length===0&&b.delete(J)}s.remove(U)}function j(U){const M=s.get(U);r.deleteTexture(M.__webglTexture);const J=U.source,_e=b.get(J);delete _e[M.__cacheKey],f.memory.textures--}function G(U){const M=s.get(U);if(U.depthTexture&&(U.depthTexture.dispose(),s.remove(U.depthTexture)),U.isWebGLCubeRenderTarget)for(let _e=0;_e<6;_e++){if(Array.isArray(M.__webglFramebuffer[_e]))for(let Ee=0;Ee<M.__webglFramebuffer[_e].length;Ee++)r.deleteFramebuffer(M.__webglFramebuffer[_e][Ee]);else r.deleteFramebuffer(M.__webglFramebuffer[_e]);M.__webglDepthbuffer&&r.deleteRenderbuffer(M.__webglDepthbuffer[_e])}else{if(Array.isArray(M.__webglFramebuffer))for(let _e=0;_e<M.__webglFramebuffer.length;_e++)r.deleteFramebuffer(M.__webglFramebuffer[_e]);else r.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&r.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&r.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let _e=0;_e<M.__webglColorRenderbuffer.length;_e++)M.__webglColorRenderbuffer[_e]&&r.deleteRenderbuffer(M.__webglColorRenderbuffer[_e]);M.__webglDepthRenderbuffer&&r.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const J=U.textures;for(let _e=0,Ee=J.length;_e<Ee;_e++){const we=s.get(J[_e]);we.__webglTexture&&(r.deleteTexture(we.__webglTexture),f.memory.textures--),s.remove(J[_e])}s.remove(U)}let K=0;function ue(){K=0}function pe(){return K}function X(U){K=U}function L(){const U=K;return U>=l.maxTextures&&nt("WebGLTextures: Trying to use "+U+" texture units while this GPU supports only "+l.maxTextures),K+=1,U}function I(U){const M=[];return M.push(U.wrapS),M.push(U.wrapT),M.push(U.wrapR||0),M.push(U.magFilter),M.push(U.minFilter),M.push(U.anisotropy),M.push(U.internalFormat),M.push(U.format),M.push(U.type),M.push(U.generateMipmaps),M.push(U.premultiplyAlpha),M.push(U.flipY),M.push(U.unpackAlignment),M.push(U.colorSpace),M.join()}function se(U,M){const J=s.get(U);if(U.isVideoTexture&&Ht(U),U.isRenderTargetTexture===!1&&U.isExternalTexture!==!0&&U.version>0&&J.__version!==U.version){const _e=U.image;if(_e===null)nt("WebGLRenderer: Texture marked for update but no image data found.");else if(_e.complete===!1)nt("WebGLRenderer: Texture marked for update but image is incomplete");else{Ge(J,U,M);return}}else U.isExternalTexture&&(J.__webglTexture=U.sourceTexture?U.sourceTexture:null);i.bindTexture(r.TEXTURE_2D,J.__webglTexture,r.TEXTURE0+M)}function ge(U,M){const J=s.get(U);if(U.isRenderTargetTexture===!1&&U.version>0&&J.__version!==U.version){Ge(J,U,M);return}else U.isExternalTexture&&(J.__webglTexture=U.sourceTexture?U.sourceTexture:null);i.bindTexture(r.TEXTURE_2D_ARRAY,J.__webglTexture,r.TEXTURE0+M)}function Se(U,M){const J=s.get(U);if(U.isRenderTargetTexture===!1&&U.version>0&&J.__version!==U.version){Ge(J,U,M);return}i.bindTexture(r.TEXTURE_3D,J.__webglTexture,r.TEXTURE0+M)}function P(U,M){const J=s.get(U);if(U.isCubeDepthTexture!==!0&&U.version>0&&J.__version!==U.version){et(J,U,M);return}i.bindTexture(r.TEXTURE_CUBE_MAP,J.__webglTexture,r.TEXTURE0+M)}const Q={[tl]:r.REPEAT,[Sa]:r.CLAMP_TO_EDGE,[xh]:r.MIRRORED_REPEAT},ye={[Un]:r.NEAREST,[zM]:r.NEAREST_MIPMAP_NEAREST,[Ec]:r.NEAREST_MIPMAP_LINEAR,[Bn]:r.LINEAR,[Dd]:r.LINEAR_MIPMAP_NEAREST,[Hr]:r.LINEAR_MIPMAP_LINEAR},Re={[GM]:r.NEVER,[jM]:r.ALWAYS,[VM]:r.LESS,[gp]:r.LEQUAL,[kM]:r.EQUAL,[vp]:r.GEQUAL,[WM]:r.GREATER,[XM]:r.NOTEQUAL};function Ue(U,M){if(M.type===Wi&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Bn||M.magFilter===Dd||M.magFilter===Ec||M.magFilter===Hr||M.minFilter===Bn||M.minFilter===Dd||M.minFilter===Ec||M.minFilter===Hr)&&nt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(U,r.TEXTURE_WRAP_S,Q[M.wrapS]),r.texParameteri(U,r.TEXTURE_WRAP_T,Q[M.wrapT]),(U===r.TEXTURE_3D||U===r.TEXTURE_2D_ARRAY)&&r.texParameteri(U,r.TEXTURE_WRAP_R,Q[M.wrapR]),r.texParameteri(U,r.TEXTURE_MAG_FILTER,ye[M.magFilter]),r.texParameteri(U,r.TEXTURE_MIN_FILTER,ye[M.minFilter]),M.compareFunction&&(r.texParameteri(U,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(U,r.TEXTURE_COMPARE_FUNC,Re[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Un||M.minFilter!==Ec&&M.minFilter!==Hr||M.type===Wi&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||s.get(M).__currentAnisotropy){const J=e.get("EXT_texture_filter_anisotropic");r.texParameterf(U,J.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,l.getMaxAnisotropy())),s.get(M).__currentAnisotropy=M.anisotropy}}}function oe(U,M){let J=!1;U.__webglInit===void 0&&(U.__webglInit=!0,M.addEventListener("dispose",z));const _e=M.source;let Ee=b.get(_e);Ee===void 0&&(Ee={},b.set(_e,Ee));const we=I(M);if(we!==U.__cacheKey){Ee[we]===void 0&&(Ee[we]={texture:r.createTexture(),usedTimes:0},f.memory.textures++,J=!0),Ee[we].usedTimes++;const Oe=Ee[U.__cacheKey];Oe!==void 0&&(Ee[U.__cacheKey].usedTimes--,Oe.usedTimes===0&&j(M)),U.__cacheKey=we,U.__webglTexture=Ee[we].texture}return J}function be(U,M,J){return Math.floor(Math.floor(U/J)/M)}function Te(U,M,J,_e){const we=U.updateRanges;if(we.length===0)i.texSubImage2D(r.TEXTURE_2D,0,0,0,M.width,M.height,J,_e,M.data);else{we.sort((Fe,Ne)=>Fe.start-Ne.start);let Oe=0;for(let Fe=1;Fe<we.length;Fe++){const Ne=we[Oe],De=we[Fe],it=Ne.start+Ne.count,at=be(De.start,M.width,4),pt=be(Ne.start,M.width,4);De.start<=it+1&&at===pt&&be(De.start+De.count-1,M.width,4)===at?Ne.count=Math.max(Ne.count,De.start+De.count-Ne.start):(++Oe,we[Oe]=De)}we.length=Oe+1;const fe=i.getParameter(r.UNPACK_ROW_LENGTH),de=i.getParameter(r.UNPACK_SKIP_PIXELS),Pe=i.getParameter(r.UNPACK_SKIP_ROWS);i.pixelStorei(r.UNPACK_ROW_LENGTH,M.width);for(let Fe=0,Ne=we.length;Fe<Ne;Fe++){const De=we[Fe],it=Math.floor(De.start/4),at=Math.ceil(De.count/4),pt=it%M.width,k=Math.floor(it/M.width),Ae=at,me=1;i.pixelStorei(r.UNPACK_SKIP_PIXELS,pt),i.pixelStorei(r.UNPACK_SKIP_ROWS,k),i.texSubImage2D(r.TEXTURE_2D,0,pt,k,Ae,me,J,_e,M.data)}U.clearUpdateRanges(),i.pixelStorei(r.UNPACK_ROW_LENGTH,fe),i.pixelStorei(r.UNPACK_SKIP_PIXELS,de),i.pixelStorei(r.UNPACK_SKIP_ROWS,Pe)}}function Ge(U,M,J){let _e=r.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(_e=r.TEXTURE_2D_ARRAY),M.isData3DTexture&&(_e=r.TEXTURE_3D);const Ee=oe(U,M),we=M.source;i.bindTexture(_e,U.__webglTexture,r.TEXTURE0+J);const Oe=s.get(we);if(we.version!==Oe.__version||Ee===!0){if(i.activeTexture(r.TEXTURE0+J),(typeof ImageBitmap<"u"&&M.image instanceof ImageBitmap)===!1){const me=bt.getPrimaries(bt.workingColorSpace),Ie=M.colorSpace===fr?null:bt.getPrimaries(M.colorSpace),Le=M.colorSpace===fr||me===Ie?r.NONE:r.BROWSER_DEFAULT_WEBGL;i.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Le)}i.pixelStorei(r.UNPACK_ALIGNMENT,M.unpackAlignment);let de=y(M.image,!1,l.maxTextureSize);de=Ce(M,de);const Pe=c.convert(M.format,M.colorSpace),Fe=c.convert(M.type);let Ne=O(M.internalFormat,Pe,Fe,M.normalized,M.colorSpace,M.isVideoTexture);Ue(_e,M);let De;const it=M.mipmaps,at=M.isVideoTexture!==!0,pt=Oe.__version===void 0||Ee===!0,k=we.dataReady,Ae=F(M,de);if(M.isDepthTexture)Ne=V(M.format===Gr,M.type),pt&&(at?i.texStorage2D(r.TEXTURE_2D,1,Ne,de.width,de.height):i.texImage2D(r.TEXTURE_2D,0,Ne,de.width,de.height,0,Pe,Fe,null));else if(M.isDataTexture)if(it.length>0){at&&pt&&i.texStorage2D(r.TEXTURE_2D,Ae,Ne,it[0].width,it[0].height);for(let me=0,Ie=it.length;me<Ie;me++)De=it[me],at?k&&i.texSubImage2D(r.TEXTURE_2D,me,0,0,De.width,De.height,Pe,Fe,De.data):i.texImage2D(r.TEXTURE_2D,me,Ne,De.width,De.height,0,Pe,Fe,De.data);M.generateMipmaps=!1}else at?(pt&&i.texStorage2D(r.TEXTURE_2D,Ae,Ne,de.width,de.height),k&&Te(M,de,Pe,Fe)):i.texImage2D(r.TEXTURE_2D,0,Ne,de.width,de.height,0,Pe,Fe,de.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){at&&pt&&i.texStorage3D(r.TEXTURE_2D_ARRAY,Ae,Ne,it[0].width,it[0].height,de.depth);for(let me=0,Ie=it.length;me<Ie;me++)if(De=it[me],M.format!==Ui)if(Pe!==null)if(at){if(k)if(M.layerUpdates.size>0){const Le=Jv(De.width,De.height,M.format,M.type);for(const Me of M.layerUpdates){const qe=De.data.subarray(Me*Le/De.data.BYTES_PER_ELEMENT,(Me+1)*Le/De.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,me,0,0,Me,De.width,De.height,1,Pe,qe)}M.clearLayerUpdates()}else i.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,me,0,0,0,De.width,De.height,de.depth,Pe,De.data)}else i.compressedTexImage3D(r.TEXTURE_2D_ARRAY,me,Ne,De.width,De.height,de.depth,0,De.data,0,0);else nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else at?k&&i.texSubImage3D(r.TEXTURE_2D_ARRAY,me,0,0,0,De.width,De.height,de.depth,Pe,Fe,De.data):i.texImage3D(r.TEXTURE_2D_ARRAY,me,Ne,De.width,De.height,de.depth,0,Pe,Fe,De.data)}else{at&&pt&&i.texStorage2D(r.TEXTURE_2D,Ae,Ne,it[0].width,it[0].height);for(let me=0,Ie=it.length;me<Ie;me++)De=it[me],M.format!==Ui?Pe!==null?at?k&&i.compressedTexSubImage2D(r.TEXTURE_2D,me,0,0,De.width,De.height,Pe,De.data):i.compressedTexImage2D(r.TEXTURE_2D,me,Ne,De.width,De.height,0,De.data):nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):at?k&&i.texSubImage2D(r.TEXTURE_2D,me,0,0,De.width,De.height,Pe,Fe,De.data):i.texImage2D(r.TEXTURE_2D,me,Ne,De.width,De.height,0,Pe,Fe,De.data)}else if(M.isDataArrayTexture)if(at){if(pt&&i.texStorage3D(r.TEXTURE_2D_ARRAY,Ae,Ne,de.width,de.height,de.depth),k)if(M.layerUpdates.size>0){const me=Jv(de.width,de.height,M.format,M.type);for(const Ie of M.layerUpdates){const Le=de.data.subarray(Ie*me/de.data.BYTES_PER_ELEMENT,(Ie+1)*me/de.data.BYTES_PER_ELEMENT);i.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,Ie,de.width,de.height,1,Pe,Fe,Le)}M.clearLayerUpdates()}else i.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,de.width,de.height,de.depth,Pe,Fe,de.data)}else i.texImage3D(r.TEXTURE_2D_ARRAY,0,Ne,de.width,de.height,de.depth,0,Pe,Fe,de.data);else if(M.isData3DTexture)at?(pt&&i.texStorage3D(r.TEXTURE_3D,Ae,Ne,de.width,de.height,de.depth),k&&i.texSubImage3D(r.TEXTURE_3D,0,0,0,0,de.width,de.height,de.depth,Pe,Fe,de.data)):i.texImage3D(r.TEXTURE_3D,0,Ne,de.width,de.height,de.depth,0,Pe,Fe,de.data);else if(M.isFramebufferTexture){if(pt)if(at)i.texStorage2D(r.TEXTURE_2D,Ae,Ne,de.width,de.height);else{let me=de.width,Ie=de.height;for(let Le=0;Le<Ae;Le++)i.texImage2D(r.TEXTURE_2D,Le,Ne,me,Ie,0,Pe,Fe,null),me>>=1,Ie>>=1}}else if(M.isHTMLTexture){if("texElementImage2D"in r){const me=r.canvas;if(me.hasAttribute("layoutsubtree")||me.setAttribute("layoutsubtree","true"),de.parentNode!==me){me.appendChild(de),g.add(M),me.onpaint=tt=>{const tn=tt.changedElements;for(const wt of g)tn.includes(wt.image)&&(wt.needsUpdate=!0)},me.requestPaint();return}const Ie=0,Le=r.RGBA,Me=r.RGBA,qe=r.UNSIGNED_BYTE;r.texElementImage2D(r.TEXTURE_2D,Ie,Le,Me,qe,de),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_MIN_FILTER,r.LINEAR),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_S,r.CLAMP_TO_EDGE),r.texParameteri(r.TEXTURE_2D,r.TEXTURE_WRAP_T,r.CLAMP_TO_EDGE)}}else if(it.length>0){if(at&&pt){const me=Kt(it[0]);i.texStorage2D(r.TEXTURE_2D,Ae,Ne,me.width,me.height)}for(let me=0,Ie=it.length;me<Ie;me++)De=it[me],at?k&&i.texSubImage2D(r.TEXTURE_2D,me,0,0,Pe,Fe,De):i.texImage2D(r.TEXTURE_2D,me,Ne,Pe,Fe,De);M.generateMipmaps=!1}else if(at){if(pt){const me=Kt(de);i.texStorage2D(r.TEXTURE_2D,Ae,Ne,me.width,me.height)}k&&i.texSubImage2D(r.TEXTURE_2D,0,0,0,Pe,Fe,de)}else i.texImage2D(r.TEXTURE_2D,0,Ne,Pe,Fe,de);S(M)&&w(_e),Oe.__version=we.version,M.onUpdate&&M.onUpdate(M)}U.__version=M.version}function et(U,M,J){if(M.image.length!==6)return;const _e=oe(U,M),Ee=M.source;i.bindTexture(r.TEXTURE_CUBE_MAP,U.__webglTexture,r.TEXTURE0+J);const we=s.get(Ee);if(Ee.version!==we.__version||_e===!0){i.activeTexture(r.TEXTURE0+J);const Oe=bt.getPrimaries(bt.workingColorSpace),fe=M.colorSpace===fr?null:bt.getPrimaries(M.colorSpace),de=M.colorSpace===fr||Oe===fe?r.NONE:r.BROWSER_DEFAULT_WEBGL;i.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,M.flipY),i.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),i.pixelStorei(r.UNPACK_ALIGNMENT,M.unpackAlignment),i.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,de);const Pe=M.isCompressedTexture||M.image[0].isCompressedTexture,Fe=M.image[0]&&M.image[0].isDataTexture,Ne=[];for(let Me=0;Me<6;Me++)!Pe&&!Fe?Ne[Me]=y(M.image[Me],!0,l.maxCubemapSize):Ne[Me]=Fe?M.image[Me].image:M.image[Me],Ne[Me]=Ce(M,Ne[Me]);const De=Ne[0],it=c.convert(M.format,M.colorSpace),at=c.convert(M.type),pt=O(M.internalFormat,it,at,M.normalized,M.colorSpace),k=M.isVideoTexture!==!0,Ae=we.__version===void 0||_e===!0,me=Ee.dataReady;let Ie=F(M,De);Ue(r.TEXTURE_CUBE_MAP,M);let Le;if(Pe){k&&Ae&&i.texStorage2D(r.TEXTURE_CUBE_MAP,Ie,pt,De.width,De.height);for(let Me=0;Me<6;Me++){Le=Ne[Me].mipmaps;for(let qe=0;qe<Le.length;qe++){const tt=Le[qe];M.format!==Ui?it!==null?k?me&&i.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe,0,0,tt.width,tt.height,it,tt.data):i.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe,pt,tt.width,tt.height,0,tt.data):nt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):k?me&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe,0,0,tt.width,tt.height,it,at,tt.data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe,pt,tt.width,tt.height,0,it,at,tt.data)}}}else{if(Le=M.mipmaps,k&&Ae){Le.length>0&&Ie++;const Me=Kt(Ne[0]);i.texStorage2D(r.TEXTURE_CUBE_MAP,Ie,pt,Me.width,Me.height)}for(let Me=0;Me<6;Me++)if(Fe){k?me&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0,0,0,Ne[Me].width,Ne[Me].height,it,at,Ne[Me].data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0,pt,Ne[Me].width,Ne[Me].height,0,it,at,Ne[Me].data);for(let qe=0;qe<Le.length;qe++){const tn=Le[qe].image[Me].image;k?me&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe+1,0,0,tn.width,tn.height,it,at,tn.data):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe+1,pt,tn.width,tn.height,0,it,at,tn.data)}}else{k?me&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0,0,0,it,at,Ne[Me]):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,0,pt,it,at,Ne[Me]);for(let qe=0;qe<Le.length;qe++){const tt=Le[qe];k?me&&i.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe+1,0,0,it,at,tt.image[Me]):i.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Me,qe+1,pt,it,at,tt.image[Me])}}}S(M)&&w(r.TEXTURE_CUBE_MAP),we.__version=Ee.version,M.onUpdate&&M.onUpdate(M)}U.__version=M.version}function Je(U,M,J,_e,Ee,we){const Oe=c.convert(J.format,J.colorSpace),fe=c.convert(J.type),de=O(J.internalFormat,Oe,fe,J.normalized,J.colorSpace),Pe=s.get(M),Fe=s.get(J);if(Fe.__renderTarget=M,!Pe.__hasExternalTextures){const Ne=Math.max(1,M.width>>we),De=Math.max(1,M.height>>we);Ee===r.TEXTURE_3D||Ee===r.TEXTURE_2D_ARRAY?i.texImage3D(Ee,we,de,Ne,De,M.depth,0,Oe,fe,null):i.texImage2D(Ee,we,de,Ne,De,0,Oe,fe,null)}i.bindFramebuffer(r.FRAMEBUFFER,U),ht(M)?p.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,_e,Ee,Fe.__webglTexture,0,en(M)):(Ee===r.TEXTURE_2D||Ee>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&Ee<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,_e,Ee,Fe.__webglTexture,we),i.bindFramebuffer(r.FRAMEBUFFER,null)}function Wt(U,M,J){if(r.bindRenderbuffer(r.RENDERBUFFER,U),M.depthBuffer){const _e=M.depthTexture,Ee=_e&&_e.isDepthTexture?_e.type:null,we=V(M.stencilBuffer,Ee),Oe=M.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;ht(M)?p.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,en(M),we,M.width,M.height):J?r.renderbufferStorageMultisample(r.RENDERBUFFER,en(M),we,M.width,M.height):r.renderbufferStorage(r.RENDERBUFFER,we,M.width,M.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Oe,r.RENDERBUFFER,U)}else{const _e=M.textures;for(let Ee=0;Ee<_e.length;Ee++){const we=_e[Ee],Oe=c.convert(we.format,we.colorSpace),fe=c.convert(we.type),de=O(we.internalFormat,Oe,fe,we.normalized,we.colorSpace);ht(M)?p.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,en(M),de,M.width,M.height):J?r.renderbufferStorageMultisample(r.RENDERBUFFER,en(M),de,M.width,M.height):r.renderbufferStorage(r.RENDERBUFFER,de,M.width,M.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function dt(U,M,J){const _e=M.isWebGLCubeRenderTarget===!0;if(i.bindFramebuffer(r.FRAMEBUFFER,U),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Ee=s.get(M.depthTexture);if(Ee.__renderTarget=M,(!Ee.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),_e){if(Ee.__webglInit===void 0&&(Ee.__webglInit=!0,M.depthTexture.addEventListener("dispose",z)),Ee.__webglTexture===void 0){Ee.__webglTexture=r.createTexture(),i.bindTexture(r.TEXTURE_CUBE_MAP,Ee.__webglTexture),Ue(r.TEXTURE_CUBE_MAP,M.depthTexture);const Pe=c.convert(M.depthTexture.format),Fe=c.convert(M.depthTexture.type);let Ne;M.depthTexture.format===Ra?Ne=r.DEPTH_COMPONENT24:M.depthTexture.format===Gr&&(Ne=r.DEPTH24_STENCIL8);for(let De=0;De<6;De++)r.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+De,0,Ne,M.width,M.height,0,Pe,Fe,null)}}else se(M.depthTexture,0);const we=Ee.__webglTexture,Oe=en(M),fe=_e?r.TEXTURE_CUBE_MAP_POSITIVE_X+J:r.TEXTURE_2D,de=M.depthTexture.format===Gr?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;if(M.depthTexture.format===Ra)ht(M)?p.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,de,fe,we,0,Oe):r.framebufferTexture2D(r.FRAMEBUFFER,de,fe,we,0);else if(M.depthTexture.format===Gr)ht(M)?p.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,de,fe,we,0,Oe):r.framebufferTexture2D(r.FRAMEBUFFER,de,fe,we,0);else throw new Error("Unknown depthTexture format")}function _t(U){const M=s.get(U),J=U.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==U.depthTexture){const _e=U.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),_e){const Ee=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,_e.removeEventListener("dispose",Ee)};_e.addEventListener("dispose",Ee),M.__depthDisposeCallback=Ee}M.__boundDepthTexture=_e}if(U.depthTexture&&!M.__autoAllocateDepthBuffer)if(J)for(let _e=0;_e<6;_e++)dt(M.__webglFramebuffer[_e],U,_e);else{const _e=U.texture.mipmaps;_e&&_e.length>0?dt(M.__webglFramebuffer[0],U,0):dt(M.__webglFramebuffer,U,0)}else if(J){M.__webglDepthbuffer=[];for(let _e=0;_e<6;_e++)if(i.bindFramebuffer(r.FRAMEBUFFER,M.__webglFramebuffer[_e]),M.__webglDepthbuffer[_e]===void 0)M.__webglDepthbuffer[_e]=r.createRenderbuffer(),Wt(M.__webglDepthbuffer[_e],U,!1);else{const Ee=U.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,we=M.__webglDepthbuffer[_e];r.bindRenderbuffer(r.RENDERBUFFER,we),r.framebufferRenderbuffer(r.FRAMEBUFFER,Ee,r.RENDERBUFFER,we)}}else{const _e=U.texture.mipmaps;if(_e&&_e.length>0?i.bindFramebuffer(r.FRAMEBUFFER,M.__webglFramebuffer[0]):i.bindFramebuffer(r.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=r.createRenderbuffer(),Wt(M.__webglDepthbuffer,U,!1);else{const Ee=U.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,we=M.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,we),r.framebufferRenderbuffer(r.FRAMEBUFFER,Ee,r.RENDERBUFFER,we)}}i.bindFramebuffer(r.FRAMEBUFFER,null)}function Lt(U,M,J){const _e=s.get(U);M!==void 0&&Je(_e.__webglFramebuffer,U,U.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),J!==void 0&&_t(U)}function ct(U){const M=U.texture,J=s.get(U),_e=s.get(M);U.addEventListener("dispose",T);const Ee=U.textures,we=U.isWebGLCubeRenderTarget===!0,Oe=Ee.length>1;if(Oe||(_e.__webglTexture===void 0&&(_e.__webglTexture=r.createTexture()),_e.__version=M.version,f.memory.textures++),we){J.__webglFramebuffer=[];for(let fe=0;fe<6;fe++)if(M.mipmaps&&M.mipmaps.length>0){J.__webglFramebuffer[fe]=[];for(let de=0;de<M.mipmaps.length;de++)J.__webglFramebuffer[fe][de]=r.createFramebuffer()}else J.__webglFramebuffer[fe]=r.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){J.__webglFramebuffer=[];for(let fe=0;fe<M.mipmaps.length;fe++)J.__webglFramebuffer[fe]=r.createFramebuffer()}else J.__webglFramebuffer=r.createFramebuffer();if(Oe)for(let fe=0,de=Ee.length;fe<de;fe++){const Pe=s.get(Ee[fe]);Pe.__webglTexture===void 0&&(Pe.__webglTexture=r.createTexture(),f.memory.textures++)}if(U.samples>0&&ht(U)===!1){J.__webglMultisampledFramebuffer=r.createFramebuffer(),J.__webglColorRenderbuffer=[],i.bindFramebuffer(r.FRAMEBUFFER,J.__webglMultisampledFramebuffer);for(let fe=0;fe<Ee.length;fe++){const de=Ee[fe];J.__webglColorRenderbuffer[fe]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,J.__webglColorRenderbuffer[fe]);const Pe=c.convert(de.format,de.colorSpace),Fe=c.convert(de.type),Ne=O(de.internalFormat,Pe,Fe,de.normalized,de.colorSpace,U.isXRRenderTarget===!0),De=en(U);r.renderbufferStorageMultisample(r.RENDERBUFFER,De,Ne,U.width,U.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+fe,r.RENDERBUFFER,J.__webglColorRenderbuffer[fe])}r.bindRenderbuffer(r.RENDERBUFFER,null),U.depthBuffer&&(J.__webglDepthRenderbuffer=r.createRenderbuffer(),Wt(J.__webglDepthRenderbuffer,U,!0)),i.bindFramebuffer(r.FRAMEBUFFER,null)}}if(we){i.bindTexture(r.TEXTURE_CUBE_MAP,_e.__webglTexture),Ue(r.TEXTURE_CUBE_MAP,M);for(let fe=0;fe<6;fe++)if(M.mipmaps&&M.mipmaps.length>0)for(let de=0;de<M.mipmaps.length;de++)Je(J.__webglFramebuffer[fe][de],U,M,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,de);else Je(J.__webglFramebuffer[fe],U,M,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+fe,0);S(M)&&w(r.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(Oe){for(let fe=0,de=Ee.length;fe<de;fe++){const Pe=Ee[fe],Fe=s.get(Pe);let Ne=r.TEXTURE_2D;(U.isWebGL3DRenderTarget||U.isWebGLArrayRenderTarget)&&(Ne=U.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),i.bindTexture(Ne,Fe.__webglTexture),Ue(Ne,Pe),Je(J.__webglFramebuffer,U,Pe,r.COLOR_ATTACHMENT0+fe,Ne,0),S(Pe)&&w(Ne)}i.unbindTexture()}else{let fe=r.TEXTURE_2D;if((U.isWebGL3DRenderTarget||U.isWebGLArrayRenderTarget)&&(fe=U.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),i.bindTexture(fe,_e.__webglTexture),Ue(fe,M),M.mipmaps&&M.mipmaps.length>0)for(let de=0;de<M.mipmaps.length;de++)Je(J.__webglFramebuffer[de],U,M,r.COLOR_ATTACHMENT0,fe,de);else Je(J.__webglFramebuffer,U,M,r.COLOR_ATTACHMENT0,fe,0);S(M)&&w(fe),i.unbindTexture()}U.depthBuffer&&_t(U)}function on(U){const M=U.textures;for(let J=0,_e=M.length;J<_e;J++){const Ee=M[J];if(S(Ee)){const we=N(U),Oe=s.get(Ee).__webglTexture;i.bindTexture(we,Oe),w(we),i.unbindTexture()}}}const qt=[],Tn=[];function q(U){if(U.samples>0){if(ht(U)===!1){const M=U.textures,J=U.width,_e=U.height;let Ee=r.COLOR_BUFFER_BIT;const we=U.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Oe=s.get(U),fe=M.length>1;if(fe)for(let Pe=0;Pe<M.length;Pe++)i.bindFramebuffer(r.FRAMEBUFFER,Oe.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Pe,r.RENDERBUFFER,null),i.bindFramebuffer(r.FRAMEBUFFER,Oe.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Pe,r.TEXTURE_2D,null,0);i.bindFramebuffer(r.READ_FRAMEBUFFER,Oe.__webglMultisampledFramebuffer);const de=U.texture.mipmaps;de&&de.length>0?i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Oe.__webglFramebuffer[0]):i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Oe.__webglFramebuffer);for(let Pe=0;Pe<M.length;Pe++){if(U.resolveDepthBuffer&&(U.depthBuffer&&(Ee|=r.DEPTH_BUFFER_BIT),U.stencilBuffer&&U.resolveStencilBuffer&&(Ee|=r.STENCIL_BUFFER_BIT)),fe){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Oe.__webglColorRenderbuffer[Pe]);const Fe=s.get(M[Pe]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Fe,0)}r.blitFramebuffer(0,0,J,_e,0,0,J,_e,Ee,r.NEAREST),m===!0&&(qt.length=0,Tn.length=0,qt.push(r.COLOR_ATTACHMENT0+Pe),U.depthBuffer&&U.resolveDepthBuffer===!1&&(qt.push(we),Tn.push(we),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Tn)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,qt))}if(i.bindFramebuffer(r.READ_FRAMEBUFFER,null),i.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),fe)for(let Pe=0;Pe<M.length;Pe++){i.bindFramebuffer(r.FRAMEBUFFER,Oe.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Pe,r.RENDERBUFFER,Oe.__webglColorRenderbuffer[Pe]);const Fe=s.get(M[Pe]).__webglTexture;i.bindFramebuffer(r.FRAMEBUFFER,Oe.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Pe,r.TEXTURE_2D,Fe,0)}i.bindFramebuffer(r.DRAW_FRAMEBUFFER,Oe.__webglMultisampledFramebuffer)}else if(U.depthBuffer&&U.resolveDepthBuffer===!1&&m){const M=U.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[M])}}}function en(U){return Math.min(l.maxSamples,U.samples)}function ht(U){const M=s.get(U);return U.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function Ht(U){const M=f.render.frame;_.get(U)!==M&&(_.set(U,M),U.update())}function Ce(U,M){const J=U.colorSpace,_e=U.format,Ee=U.type;return U.isCompressedTexture===!0||U.isVideoTexture===!0||J!==ru&&J!==fr&&(bt.getTransfer(J)===It?(_e!==Ui||Ee!==li)&&nt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Et("WebGLTextures: Unsupported texture color space:",J)),M}function Kt(U){return typeof HTMLImageElement<"u"&&U instanceof HTMLImageElement?(h.width=U.naturalWidth||U.width,h.height=U.naturalHeight||U.height):typeof VideoFrame<"u"&&U instanceof VideoFrame?(h.width=U.displayWidth,h.height=U.displayHeight):(h.width=U.width,h.height=U.height),h}this.allocateTextureUnit=L,this.resetTextureUnits=ue,this.getTextureUnits=pe,this.setTextureUnits=X,this.setTexture2D=se,this.setTexture2DArray=ge,this.setTexture3D=Se,this.setTextureCube=P,this.rebindTextures=Lt,this.setupRenderTarget=ct,this.updateRenderTargetMipmap=on,this.updateMultisampleRenderTarget=q,this.setupDepthRenderbuffer=_t,this.setupFrameBufferTexture=Je,this.useMultisampledRTT=ht,this.isReversedDepthBuffer=function(){return i.buffers.depth.getReversed()}}function bC(r,e){function i(s,l=fr){let c;const f=bt.getTransfer(l);if(s===li)return r.UNSIGNED_BYTE;if(s===fp)return r.UNSIGNED_SHORT_4_4_4_4;if(s===dp)return r.UNSIGNED_SHORT_5_5_5_1;if(s===$_)return r.UNSIGNED_INT_5_9_9_9_REV;if(s===ex)return r.UNSIGNED_INT_10F_11F_11F_REV;if(s===Q_)return r.BYTE;if(s===J_)return r.SHORT;if(s===nl)return r.UNSIGNED_SHORT;if(s===up)return r.INT;if(s===Zi)return r.UNSIGNED_INT;if(s===Wi)return r.FLOAT;if(s===Aa)return r.HALF_FLOAT;if(s===tx)return r.ALPHA;if(s===nx)return r.RGB;if(s===Ui)return r.RGBA;if(s===Ra)return r.DEPTH_COMPONENT;if(s===Gr)return r.DEPTH_STENCIL;if(s===ix)return r.RED;if(s===hp)return r.RED_INTEGER;if(s===kr)return r.RG;if(s===pp)return r.RG_INTEGER;if(s===mp)return r.RGBA_INTEGER;if(s===Kc||s===Qc||s===Jc||s===$c)if(f===It)if(c=e.get("WEBGL_compressed_texture_s3tc_srgb"),c!==null){if(s===Kc)return c.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Qc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===Jc)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===$c)return c.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(c=e.get("WEBGL_compressed_texture_s3tc"),c!==null){if(s===Kc)return c.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Qc)return c.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===Jc)return c.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===$c)return c.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===yh||s===Sh||s===bh||s===Mh)if(c=e.get("WEBGL_compressed_texture_pvrtc"),c!==null){if(s===yh)return c.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===Sh)return c.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===bh)return c.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===Mh)return c.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===Eh||s===Th||s===Ah||s===Rh||s===Ch||s===iu||s===wh)if(c=e.get("WEBGL_compressed_texture_etc"),c!==null){if(s===Eh||s===Th)return f===It?c.COMPRESSED_SRGB8_ETC2:c.COMPRESSED_RGB8_ETC2;if(s===Ah)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:c.COMPRESSED_RGBA8_ETC2_EAC;if(s===Rh)return c.COMPRESSED_R11_EAC;if(s===Ch)return c.COMPRESSED_SIGNED_R11_EAC;if(s===iu)return c.COMPRESSED_RG11_EAC;if(s===wh)return c.COMPRESSED_SIGNED_RG11_EAC}else return null;if(s===Dh||s===Uh||s===Nh||s===Lh||s===Oh||s===Ph||s===Fh||s===Bh||s===zh||s===Ih||s===Hh||s===Gh||s===Vh||s===kh)if(c=e.get("WEBGL_compressed_texture_astc"),c!==null){if(s===Dh)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:c.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Uh)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:c.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Nh)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:c.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Lh)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:c.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===Oh)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:c.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Ph)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:c.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===Fh)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:c.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Bh)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:c.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===zh)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:c.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Ih)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:c.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Hh)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:c.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Gh)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:c.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Vh)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:c.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===kh)return f===It?c.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:c.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===Wh||s===Xh||s===jh)if(c=e.get("EXT_texture_compression_bptc"),c!==null){if(s===Wh)return f===It?c.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:c.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(s===Xh)return c.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(s===jh)return c.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(s===qh||s===Yh||s===au||s===Zh)if(c=e.get("EXT_texture_compression_rgtc"),c!==null){if(s===qh)return c.COMPRESSED_RED_RGTC1_EXT;if(s===Yh)return c.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(s===au)return c.COMPRESSED_RED_GREEN_RGTC2_EXT;if(s===Zh)return c.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return s===il?r.UNSIGNED_INT_24_8:r[s]!==void 0?r[s]:null}return{convert:i}}const MC=`
void main() {
